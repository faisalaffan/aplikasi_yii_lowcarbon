...
/**
 * This is the model class for table "tbl_tegangan".
 *
 * The followings are the available columns in table 'tbl_tegangan':
 * @property string $id_tegangan
...
class Tegangan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_tegangan, id_station, nilai, waktu, ket', 'required'),
			array('nilai', 'numerical'),
			array('id_tegangan, id_station', 'length', 'max'=>100),
			array('ket', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tegangan, id_station, nilai, waktu, ket', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_tegangan',$this->id_tegangan,true);
