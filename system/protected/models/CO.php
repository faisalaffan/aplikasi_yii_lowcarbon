...
/**
 * This is the model class for table "tbl_co".
 *
 * The followings are the available columns in table 'tbl_co':
 * @property string $id_co
...
class CO extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_co, id_station, nilai, waktu, ket', 'required'),
			array('nilai', 'numerical'),
			array('id_co, id_station', 'length', 'max'=>100),
			array('ket', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_co, id_station, nilai, waktu, ket', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_co',$this->id_co,true);
