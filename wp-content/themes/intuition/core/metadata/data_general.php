...
if(!function_exists('cpotheme_metadata_layoutstyle')){
	function cpotheme_metadata_layoutstyle(){
		$data = array(
		'fixed' => __('Full Width', 'intuition'),
		'boxed' => __('Boxed', 'intuition'));
		return $data;
	}
}
...
function cpotheme_metadata_featured_page(){
	$data = array(
	'none' => __('None', 'intuition'),
	'slider' => __('In The Slider', 'intuition'),
	'features' => __('In The Featured Boxes', 'intuition'));
