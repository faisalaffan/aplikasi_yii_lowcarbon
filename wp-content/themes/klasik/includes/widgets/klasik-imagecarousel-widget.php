...
class Klasik_PCarouselWidget extends WP_Widget {
  ...
  /** @see WP_Widget::widget */
		...
		global $wp_query;
		  ...
		  echo $before_widget; 
					...
					$background='';
					 ...
					 echo '<div class="klasik-carousel-widget-wrapper"  style="'.$spacing_left_right.'">';
				...
				?>
					...
					<div class="klasik-pcarousel flexslider-carousel car-flex-<?php echo $this->get_field_id('klasik-theme-pfilter-widget').$mediaid;?> <?php echo 'col'.$imagecols?> row">
                    <ul class="slides">
					<?php
                     ...
                     foreach ($attachments as $id => $attachment) {
                        ...
                        $cf_thumb = wp_get_attachment_image($id, 'widget-carousel', false, false);
                    ...
                    jQuery(document).ready(function(){
                        ...
                        jQuery('.car-flex-<?php echo $this->get_field_id('klasik-theme-pfilter-widget').$mediaid;?>').flexslider({
                            animation: "slide",
                            touch:true,
                            animationLoop: false,
							//smoothHeight: true,
    ...
    function update($new_instance, $old_instance) {				
		...
		$instance['imagecols'] 				= strip_tags($new_instance['imagecols']);
        ...
        ?>
            ...
            <select id="<?php echo $this->get_field_id('imagecols'); ?>" name="<?php echo $this->get_field_name('imagecols'); ?>" class="widefat" style="width:50%;">
				<?php foreach($this->get_image_number_options() as $k => $v ) { ?>
                    <option <?php selected( $instance['imagecols'], $k); ?> value="<?php echo $k; ?>"><?php echo $v; ?></option>
                <?php } ?>      
            </select></p>
