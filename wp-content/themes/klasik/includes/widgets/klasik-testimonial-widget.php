        ...
        if ( $customclass ) {
            $before_widget = str_replace('class="', 'class="'. $customclass . ' ', $before_widget);
					...
					$background='';
					 ...
					 echo '<div class="klasik-testimonial-widget-wrapper"  style="'.$spacing_left_right.'">';
					...
					$output .='<div class="klasik-testimonial-widget '.$withcarousel.' col'.$cols.'">';
						$output .='<div class="row">';
						
							//CAROUSEL
							if( $display == 'carousel'){ 
							
								if(KLASIK_TESTI_NAV == 'control'){
									$controlNav ='true';
									$directionNav ='false';
									$UsecontrolNav ='usecontrolnav';
								}elseif(KLASIK_TESTI_NAV == 'directional'){
									$controlNav ='false';
									$directionNav ='true';
									$UsecontrolNav ='nocontrolnav';
								}elseif(KLASIK_TESTI_NAV == 'both'){
									$controlNav ='true';
									$directionNav ='true';
									$UsecontrolNav ='usecontrolnav';
								}else{
								...
								$output .= '<div class="klasik-testi flexslider-carousel '.$UsecontrolNav.' testi-flex-'.$this->get_field_id('klasik-theme-pfilter-widget').$category.'">';
					...
					<?php if( $display == 'carousel'){ ?>
                        ...
                        jQuery(document).ready(function(){
                            //CAROUSEL
                            jQuery(".testi-flex-<?php echo $this->get_field_id('klasik-theme-pfilter-widget').$category;?>").flexslider({
                                animation: "slide",
                                touch:true,
								smoothHeight: true,
                                animationLoop: false,
