...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'metropoly' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'metropoly' ) ) ) );
...
function customizer_library_get_google_font_uri( $fonts ) {
	...
	$subset = metropoly_option( 'font-subset', customizer_library_get_default( 'font-subset' ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'metropoly' ),
		'cyrillic'     => __( 'Cyrillic', 'metropoly' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'metropoly' ),
		'devanagari'   => __( 'Devanagari', 'metropoly' ),
		'greek'        => __( 'Greek', 'metropoly' ),
		'greek-ext'    => __( 'Greek Extended', 'metropoly' ),
		'khmer'        => __( 'Khmer', 'metropoly' ),
		'latin'        => __( 'Latin', 'metropoly' ),
		'latin-ext'    => __( 'Latin Extended', 'metropoly' ),
		'vietnamese'   => __( 'Vietnamese', 'metropoly' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'metropoly' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'metropoly' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'metropoly' ),
