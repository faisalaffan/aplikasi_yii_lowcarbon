                ...
                <div class="entry-box-wrap timeline-<?php echo $position;?>">
                  <article class="entry-box">
                    ...
                    <div class="feature-img-box">
                      <div class="img-box figcaption-middle text-center from-top fade-in"> <a href="<?php the_permalink();?>">
                    ...
                    <div class="entry-main">
                      ...
                      <div class="entry-summary"> <?php echo metropoly_get_summary();?> </div>
                      <div class="entry-footer"> <a href="<?php the_permalink();?>" class="btn-normal">
                        <?php _e('Read More','metropoly');?>
                        &gt;&gt;</a> </div>
                    </div>
                  </article>
                </div>
