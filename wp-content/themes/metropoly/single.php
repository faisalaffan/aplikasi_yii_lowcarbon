...
get_header(); 
//$sidebar                  = esc_attr(metropoly_option('blog_single_sidebar','none'));
...
$single_display_title_bar = esc_attr(metropoly_option('single_display_title_bar','yes'));

$sidebar ='none';
$left_sidebar              = esc_attr(metropoly_option('left_sidebar_blog_posts',''));
$right_sidebar             = esc_attr(metropoly_option('right_sidebar_blog_posts',''));
if( $left_sidebar !='' )
$sidebar ='left';
if( $right_sidebar !='' )
$sidebar ='right';
...
<section class="page-title-bar title-<?php echo $page_title_align;?> no-subtitle <?php echo $title_bar_css_class;?>">
            <div class="container">
                ...
                <?php metropoly_get_breadcrumb(array("before"=>"<div class='breadcrumb-nav text-light'>","after"=>"</div>","show_browse"=>false,"separator"=>''));?>    
