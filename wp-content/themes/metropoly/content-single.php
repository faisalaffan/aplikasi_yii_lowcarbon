 ...
 */
 ...
 $display_image       = metropoly_option('single_display_image');
 
 $display_meta_data   = isset($metropoly_page_meta['display_meta_data'])?esc_attr($metropoly_page_meta['display_meta_data']):'1';
 $display_share_icons = isset($metropoly_page_meta['display_share_icons'])?esc_attr($metropoly_page_meta['display_share_icons']):'1';
 $display_author_info = isset($metropoly_page_meta['display_author_info'])?esc_attr($metropoly_page_meta['display_author_info']):'1';
 $display_related     = isset($metropoly_page_meta['display_related'])?esc_attr($metropoly_page_meta['display_related']):'1';
 $display_title       = isset($metropoly_page_meta['display_title'])?esc_attr($metropoly_page_meta['display_title']):'1';
?>
<section class="post-main" role="main" id="content">
                                 ...
                                 <?php if (  $display_image == 'yes' && has_post_thumbnail() ) : ?>
                                    ...
                                    <div class="entry-main">
                                        <div class="entry-header">      
                                            <?php if(metropoly_option('display_post_title') == 'yes'):?>    
                                ...
                                <?php if($display_author_info == '1'):?>   
                                    <!--About Author-->
                                    <?php if(metropoly_option('display_author_info_box') == 'yes'):?>
                                    <div class="about-author">
                                        <h3><?php _e( 'About the author', 'metropoly' );?>: <?php the_author_link(); ?></h3>
									...
									$display_related_posts  = metropoly_option('display_related_posts','yes');
									if( $display_related_posts == 'yes' ){
									$related_number         = metropoly_option('related_number',8);
									$related                = metropoly_get_related_posts($post->ID, $related_number,'post'); 
                                    ...
                                    <div class="related-posts">
                                        <h3><?php _e( 'Related Posts', 'metropoly' );?></h3>
                                        <div class="multi-carousel metropoly-related-posts owl-carousel owl-theme">
                                        
                            <?php while($related->have_posts()): $related->the_post(); ?>
							<?php if(has_post_thumbnail()): ?>
                            <?php 
							       $thumb_image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'metropoly-related-post');
							?>
                                            <div class="owl-item">
