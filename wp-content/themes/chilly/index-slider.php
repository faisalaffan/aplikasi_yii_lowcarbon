<?php
	$home_slider_image = get_theme_mod('home_slider_image',get_stylesheet_directory_uri() .'/images/slider.jpg');
	$home_slider_title = get_theme_mod('home_slider_title','Welcome to SpiceShop Theme');
		...
		<?php $slider_image_overlay = get_theme_mod('slider_image_overlay',true);
			...
			<div class="container">
					<div class="format-standard">
						...
						<h1><?php echo esc_attr($home_slider_title);  ?></h1>
						<?php } 
						if ( ! empty( $home_slider_discription ) || is_customize_preview() ) {
						?>
						<p><?php echo esc_attr($home_slider_discription); ?></p>
						<?php } ?>
						</div>
