...
<div class="container">
    ...
    <?php
        $theme_lay = get_theme_mod( 'vw_solar_energy_theme_options','Right Sidebar');
        if($theme_lay == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div id="our-services" class="services col-lg-8 col-md-8">
                    ...
                    printf( esc_html__( 'Results For: %s','vw-solar-energy'), esc_html( get_search_query() ) ); ?></h1> 
                    <?php if ( have_posts() ) :
                        /* Start the Loop */
                    ...
                    <div class="navigation">
                        <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => __( 'Previous page', 'vw-solar-energy' ),
                                'next_text'          => __( 'Next page', 'vw-solar-energy' ),
                                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-solar-energy' ) . ' </span>',
                            ) );
                        ?>
